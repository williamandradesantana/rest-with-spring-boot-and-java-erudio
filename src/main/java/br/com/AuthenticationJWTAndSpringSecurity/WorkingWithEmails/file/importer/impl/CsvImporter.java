package br.com.AuthenticationJWTAndSpringSecurity.WorkingWithEmails.file.importer.impl;
...
public class CsvImporter implements FileImporter {
    ...
    public List<PersonDTO> importFile(InputStream inputStream) throws Exception {
        ...
        return parseRecordsPersonDTOs(records);
    }

    private List<PersonDTO> parseRecordsPersonDTOs(Iterable<CSVRecord> records) {
