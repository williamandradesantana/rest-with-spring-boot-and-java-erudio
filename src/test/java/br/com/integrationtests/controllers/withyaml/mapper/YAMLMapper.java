package br.com.integrationtests.controllers.withyaml.mapper;
...
public class YAMLMapper implements ObjectMapper {
    ...
    public Object deserialize(ObjectMapperDeserializationContext context) {
        ...
        try {
            ...
            throw new IllegalArgumentException("Error deserialize YAML content" + e.getMessage());
        }
    }
    ...
    public Object serialize(ObjectMapperSerializationContext context) {
        try {
            ...
            throw new IllegalArgumentException("Error serializing YAML content" + e.getMessage());
        }
    }
}
